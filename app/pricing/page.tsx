...
const pricingFAQs = [
  { question: "Is this a subscription?", answer: "No. NexaAI plans are a one-time payment with lifetime access. There are no recurring monthly or annual charges." },
  ...
  { question: "Can I upgrade my plan later?", answer: "Yes. You can upgrade from Starter to Growth or Elite at any time by paying the differential. Contact support@nexaai.in to process an upgrade." },
